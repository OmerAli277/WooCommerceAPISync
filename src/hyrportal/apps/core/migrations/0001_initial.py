# Generated by Django 2.2.8 on 2020-02-12 16:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_no', models.CharField(blank=True, max_length=128, null=True, unique=True)),
                ('customer_name', models.CharField(blank=True, max_length=128, null=True)),
                ('account_type', models.CharField(choices=[('fortnox', 'Fortnox'), ('visma', 'Visma')], default='fortnox', max_length=128)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_total', models.CharField(blank=True, max_length=255, null=True)),
                ('discount_tax', models.CharField(blank=True, max_length=255, null=True)),
                ('shipping_total', models.CharField(blank=True, max_length=255, null=True)),
                ('shipping_tax', models.CharField(blank=True, max_length=255, null=True)),
                ('cart_tax', models.CharField(blank=True, max_length=255, null=True)),
                ('total', models.CharField(blank=True, max_length=255, null=True)),
                ('total_tax', models.CharField(blank=True, max_length=255, null=True)),
                ('prices_include_tax', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.CharField(blank=True, default=0, max_length=255, null=True)),
                ('regular_price', models.CharField(blank=True, default=0, max_length=255, null=True)),
                ('sale_price', models.CharField(blank=True, default=0, max_length=255, null=True)),
                ('total_sales', models.CharField(blank=True, default=0, max_length=255, null=True)),
