...
#     version = models.CharField(choices=(2, 3), max_length=255, blank=True, null=True)
...
#     vat_rate = models.CharField(choices=(2, 3), default='25', max_length=255)
#
...
#     article_type = models.CharField(choices=(2, 3), max_length=255, blank=True, null=True)
#
...
#     ]
#
#     user = models.ForeignKey(to="user.UserProfile", related_name="wc_transactions", on_delete=models.CASCADE)
#     subscription = models.ForeignKey(to="core.Subscription", related_name="wc_transactions", blank=True, null=True,
#                                      on_delete=models.SET_NULL)
#     accounting_type = models.SmallIntegerField(choices=ACCOUNT_TYPES, blank=True, null=True)
