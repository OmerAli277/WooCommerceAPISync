...
from hyrportal.apps.core.models import WooCommerceDetails, fortnoxSettings
...
def see_you():
    ...
    if woo_details is not None:
        sync = woo_fn_sync(woo_details.host, woo_details.consumer_key, woo_details.consumer_secret)
